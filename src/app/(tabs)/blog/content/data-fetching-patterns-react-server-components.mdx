...
under the hood. But in April 2024, the React team
[removed this behavior](https://github.com/facebook/react/pull/28896) after some RSC framework maintainers pushed back
on it. Now it's up to frameworks like Next.js to reimplement it in userspace.
...
export const metadata = {
  ...
  metaDescription:
    "Learn data fetching patterns in React Server Components. Covers server-owned data, client-owned data, crossing the server-client boundary, React cache API, and React Query hydration.",
};
