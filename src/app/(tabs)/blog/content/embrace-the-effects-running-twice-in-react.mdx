...
<img
  height="506"
  width="962px"
  alt="console output with effect being called twice"
  src="https://res.cloudinary.com/gauravthakur/image/upload/s--bLGtEsUw--/v1689436203/blog/console-output-with-effect-called-twice_wdhuxt.webp"
/>
...
export const metadata = {
  ...
  metaDescription:
    "Most React developers don't understand why effects run twice. Here we cover the reasons to embrace it rather than consider it a bug",
