...
[working of execution context in JavaScript](/blog/what-is-execution-context-in-javascript)
...
export const metadata = {
    ...
    description: "Hoisting in JavaScript is a phenomenon where we can access the variables and functions before they are initialized. Let's learn about hosting in JavaScript and how execution context plays an important role in Hoisting.",
    metaDescription: "Hoisting in JavaScript is a phenomenon where we can access the variables and functions before they are initialized. Let's learn more about hosting in this article",
}
