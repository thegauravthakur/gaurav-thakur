...
<img
  alt="Element Kind transition in V8"
  height="600"
  width="100%"
...
export const metadata = {
  ...
  metaDescription:
    "Arrays are a type of object in JavaScript but with only numeric keys. Let us see how JavaScript engine optimizes these special objects with purely numeric keys",
};
