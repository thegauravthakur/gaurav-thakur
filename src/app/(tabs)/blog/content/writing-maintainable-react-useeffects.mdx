...
Beyond just cleaning up the render body, <Highlight>this forces you to be honest about your dependencies</Highlight>.
When logic lives inside the component, it’s easy to accidentally grab a variable from the component scope and forget to
