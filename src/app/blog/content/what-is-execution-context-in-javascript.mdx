...
export const metadata = {
    ...
    createdAt: "December 26, 2021",
    description: "The execution context is one of the very essential component of a JavaScript engine. The execution context is the environment in which the code is executed. In this article we will discuss the working of execution context in great details",
    metaDescription: "What is an execution context in JavaScript? In this article we will discuss the working of execution context in great details",
}
